...
public class SampleDataProvider {
    ...
    public static List<DataItem> dataItemList;   // this is a list interface its implementation is an array list.
    public static Map<String, DataItem> dataItemMap;  //this is a map interface its implementation is a map.

    static {                                       // The static block is a block of code that executes only once,
                                                    // when the class is loaded.
                                                    // This can be used to initialize the static variables.
        dataItemList = new ArrayList<>();
        dataItemMap = new HashMap<>();               //uses keys and values inorder to map the values. Allows no duplicate values.
